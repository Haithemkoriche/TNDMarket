...
<head>
    ...
    <link rel="icon" href="{{ asset('favicon.ico') }}" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>TND Market</title>
    <link rel="stylesheet" type="text/css" href="{{ asset('loader.css') }}" />

    <!-- CSS du build de production -->
    <link rel="stylesheet" href="{{ asset('assets/main-DX825OFy.css') }}" />
</head>
...
<body>
    ...
    <!-- Script du build de production -->
    <script type="module" src="{{ asset('assets/main-Dc8fLLio.js') }}"></script>
