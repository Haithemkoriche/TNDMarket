<script setup>
import teamPerson1 from '@images/front-pages/landing-page/team-member-1.png'; // Remplacez par votre image
import teamPerson2 from '@images/front-pages/landing-page/team-member-2.png'; // Remplacez par votre image
import teamPerson3 from '@images/front-pages/landing-page/team-member-3.png'; // Remplacez par votre image
import teamPerson4 from '@images/front-pages/landing-page/team-member-4.png'; // Remplacez par votre image
    ...
    <div class="our-team pa-">
      <div class="headers d-flex justify-center flex-column align-center">
        ...
        <p class="text-center text-body-1 mb-0">
          Découvrez les personnes qui travaillent dur pour simplifier vos rendez-vous médicaux.
        </p>
      </div>
